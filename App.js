...
export default function App() {
      ...
      if (user) {
        ...
        try {
          ...
          if (docSnapshot.exists()) {
            ...
            await setDoc(userRef, { lastLogin: moment().format() });
          }
        } catch (error) {
  ...
  useEffect(() => {
    Font.loadAsync({
      Inter_400Regular: require("./assets/fonts/VendSans-Regular.ttf"),
      Inter_500Medium: require("./assets/fonts/VendSans-Bold.ttf"),
