      ...
      >
        ...
        >
          ...
          <View className="mb-6">
            ...
            <View className="bg-gray-50 dark:bg-gray-800 rounded border border-gray-300 dark:border-gray-700 mb-2">
              <Picker
            ...
            {selectedReason === "other" && (
              <TextInput
                ...
                multiline
                numberOfLines={5}
                className="bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white text-base rounded px-4 pb-2 border border-gray-300 dark:border-gray-700"
                maxLength={400}
                editable={!loading}
              />
            )}
          ...
          <Pressable
            ...
            className="bg-red-500 py-3 rounded flex-row items-center justify-center"
          >
            {loading ? (
              <ActivityIndicator color="white" />
            ) : (
              <>
                <Text className="text-white font-semibold text-lg" style={{ fontFamily: "Inter_400Regular" }}>
                  {i18n.t("OK")}
                </Text>
              </>
            )}
