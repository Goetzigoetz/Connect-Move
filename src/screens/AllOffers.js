  ...
  try {
    ...
    if (purchaserInfo.customerInfo.entitlements.active) {
      ...
      showMessage({
        ...
        description: `Votre abonnement (${activeEntitlement}) a été activé avec succès, veuillez fermer l'app et la réouvrir si les changements n'ont pas été directement éffectués.`,
        type: "info",
      });
      navigation.goBack();
    }
