...
const History = () => {
    ...
    return (
      <View className="flex-1 justify-center items-center bg-gray-100 dark:bg-gray-900">
        ...
        <Text className="text-gray-700 dark:text-gray-300 mt-4">
          {i18n.t("chargement_des_activites")}
        </Text>
      </View>
    );
  }
    ...
    return (
      <View className="flex-1 justify-center items-center bg-gray-100 dark:bg-gray-900">
        <Text className="text-gray-500 dark:text-gray-400 text-lg">
          {i18n.t("vous_navez_rejoint_aucune_activite_pour_le_moment")}
        </Text>
      </View>
    );
  }
  ...
  if (activities.length === 0) {
    return (
      <View className="flex-1 justify-center items-center bg-gray-100 dark:bg-gray-900">
        <Text className="text-gray-500 dark:text-gray-400 text-lg">
          {i18n.t("vous_navez_rejoint_aucune_activité_pour_le_moment")}
        </Text>
      </View>
    );
  }
      ...
      <Animated.View entering={FadeInDown.duration(400)} className="flex-1">
        <FlatList
          ...
          renderItem={({ item }) => {
            ...
            return (
              <View className="bg-gray-100 dark:bg-gray-800 rounded mb-6 p-4">
                ...
                <View className="bg-blue-100 dark:bg-blue-800 rounded p-3 mb-4">
