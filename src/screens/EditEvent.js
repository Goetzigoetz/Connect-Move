  ...
  return (
    ...
    >
      <View className="">
        ...
        <View>
          <Text className="text-lg  text-gray-900 dark:text-white mt-4 mb-2">
            {i18n.t("nombre_de_participants_max")}
          </Text>
          <Slider
        ...
        <View>
          ...
          >
            <View
              className="mt-3 bg-gray-100 dark:bg-gray-800 rounded px-4 py-4 border-b border-gray-300 dark:border-gray-700"
              style={{
        ...
        <View className="mb-8">
          ...
          >
            <View
              className="mt-3 bg-gray-100 dark:bg-gray-800 rounded px-4 py-4 text-lg border-b border-gray-300 dark:border-gray-700"
              style={{
                justifyContent: "center",
              }}
            >
