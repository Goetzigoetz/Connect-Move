          ...
          <View className="flex flex-col gap-4">
            ...
            {/* <View>
              ...
              <View className="relative">
                <TextInput
                  style={{ fontFamily: "Inter_400Regular" }}
                  className="h-[56px] border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white text-lg rounded px-4"
            ...
            <View>
              <Text
                ...
                className="text-gray-700 dark:text-gray-300 mb-2 "
              >
                {i18n.t("nom_dutilisateur")}
              </Text>
              <View className="relative">
                <TextInput
                  style={{ fontFamily: "Inter_400Regular" }}
                  className="h-[40px] pb-2 border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white text-lg rounded px-4"
            ...
            <View>
              <Text className="text-gray-700 dark:text-gray-300 mb-2 ">
                {i18n.t("parlez_nous_un_peu_de_vous")}
              </Text>
              <View className="relative">
                <TextInput
                  className="border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white rounded p-4  min-h-[150px]"
            ...
            <Pressable
              ...
              onPress={handleSave}
              disabled={!biography}
              className={`py-3 rounded flex-row items-center justify-center mt-4`}
            >
              <Text
                style={{ fontFamily: "Inter_400Regular" }}
