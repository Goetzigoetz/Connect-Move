...
const OnboardingStep5 = ({ userData, onNext, onBack }) => {
  ...
  const getAddressFromCoordinates = async (latitude, longitude) => {
    try {
      ...
      if (data.results && data.results.length > 0) {
        ...
        // Construire l'adresse de rue (numéro + nom de rue)
    ...
    try {
      ...
      if (!hasPermission) {
        Alert.alert(
          ...
          [
            { text: t("onboarding_step5_manual_entry"), onPress: () => setManualInput(true) },
...
{/* Title */}
          <Text style={styles.title}>{t("onboarding_step5_title")}</Text>
          <Text style={styles.subtitle}>
            {t("onboarding_step5_subtitle")}
          </Text>
          ...
          <View style={styles.dividerContainer}>
            ...
            <Text style={styles.dividerText}>{t("onboarding_step5_or")}</Text>
            <View style={styles.dividerLine} />
          </View>
          ...
          <View style={styles.inputsContainer}>
            <View style={styles.inputWrapper}>
              <Text style={styles.label}>{t("onboarding_step5_adresse_label")}</Text>
              <TextInput
                style={[styles.input, {
            ...
            <View style={styles.inputWrapper}>
              <Text style={styles.label}>{t("onboarding_step5_ville_label")}</Text>
              <TextInput
                style={[styles.input, {
                    backgroundColor: isDarkMode ? "#27272A" : "#FFFFFF",
                    color: isDarkMode ? "#FFFFFF" : "#000000"
            ...
            <View style={styles.inputWrapper}>
              <Text style={styles.label}>{t("onboarding_step5_pays_label")}</Text>
              <TextInput
                style={[styles.input, {
                    backgroundColor: isDarkMode ? "#27272A" : "#FFFFFF",
                    color: isDarkMode ? "#FFFFFF" : "#000000"
